    ...
    <View style={styles.container}>
      ...
      <ScrollView style={styles.content}>
        <View style={styles.card}>
          ...
          <Text style={styles.cardText}>Face the person and make eye contact when speaking</Text>
        </View>
        ...
        <View style={styles.categorySection}>
          ...
          <View style={styles.categoryIcons}>
            ...
            <TouchableOpacity onPress={() => {router.push('/(tabs)/lessons/greetings')}} style={styles.categoryItem}>
