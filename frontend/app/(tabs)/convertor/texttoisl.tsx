...
export const wordVideos: VideoAssets = {
  ...
  'who': require('../../../assets/dataset/Who.mp4'),
  'whole': require('../../../assets/dataset/Whole.mp4'),
  'whose': require('../../../assets/dataset/Whose.mp4'),
  'why': require('../../../assets/dataset/Why.mp4'),
  'will': require('../../../assets/dataset/Will.mp4'),
  'with': require('../../../assets/dataset/With.mp4'),
  'without': require('../../../assets/dataset/Without.mp4'),
  'words': require('../../../assets/dataset/Words.mp4'),
  'work': require('../../../assets/dataset/Work.mp4'),
